...
export default function Home() {
	...
	useEffect(() => {
		const calculateTime = () => {
			const now = new Date();
			const targetDate = new Date(now.getFullYear(), 2, 10, 13, 35); // March 10th at 13:35 (month is 0-indexed)
	...
	return (
		<main className="flex items-center justify-center h-screen">
			<header className="fixed top-8 left-8 text-3xl font-bold">
			...
			<div className="flex flex-col gap-4 items-center">
				...
				<p className="flex flex-col md:flex-row text-7xl font-bold">
